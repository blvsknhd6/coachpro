  ...
  return (
    <Layout>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-gray-400 text-sm">Ton coach n'a pas encore créé de programme.</div>
      ) : (
            ...
            return (
              <Link key={seance.id} to={`/athlete/seance/${seance.id}/semaine/${activeSemaine?.id}`}
                ...
                <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                  <div className={`h-full ${theme.progress} rounded-full transition-all`} style={{ width: `${pct}%` }} />
                </div>
